...
# regex - для створення патернів, що обмежують або знаходять певні дані в стрінзі (шаблони пошуку по тексту)
# використовують для валідації даних введених у веб форми та скраппінгу - коли треба щось розпарсити і познаходити - бо він є швидшим ніж пошук по стрінзі
# автоматизація - селеніум - автоматизація веб програмування -  х-паси - пошук по DOM дереву 

# щодо різниці в різних мовах програмування - аони є лише невеликі - треба перевіряти 
...
pattern = "Thi"
# search - шукає за вказаним патерном по вказаному тектсу
